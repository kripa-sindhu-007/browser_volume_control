...
- Should volume preferences be saved automatically or only when the user chooses to save them?
- Should the extension remember settings by exact website, full domain, or broader site group?
- Should Boost be limited to avoid uncomfortable or distorted audio?
- Should users see all currently audible tabs in a future version?
- Should keyboard shortcuts be part of a later release?

## Future Opportunities

- Mixer view for all audible tabs.
- Keyboard shortcuts for quick mute and volume changes.
- Temporary focus mode that lowers background tabs.
- Profiles for work, entertainment, and late-night browsing.
- Optional visual indicator when a tab is being controlled.
